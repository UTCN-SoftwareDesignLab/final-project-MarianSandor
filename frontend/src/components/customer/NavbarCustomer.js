...
function NavbarCustomer({ type, setType, setParts, setConfigurations }) {
  ...
  const configurationRequestHandler = () => {
  ...
  return (
    <div style={{ position: "sticky", top: "0" }}>
      <Navbar sticky="top" bg="light" expand="lg">
        ...
        <Button
          style={{ marginLeft: "2%" }}
          onClick={configurationRequestHandler}
        >
          Request Configuration
        </Button>
        <Button style={{ marginLeft: "8%" }} onClick={logoutHandler}>
          Logout
        </Button>
      </Navbar>
    </div>
